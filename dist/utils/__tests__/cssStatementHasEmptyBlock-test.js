...
var _cssStatementHasEmptyBlock2 = _interopRequireDefault(_cssStatementHasEmptyBlock);
...
(0, _tape2.default)("cssStatementHasEmptyBlock", function (t) {
...
function postcssCheck(cssString) {
  ...
  return (0, _cssStatementHasEmptyBlock2.default)(root.first);
}